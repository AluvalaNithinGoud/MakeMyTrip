...
@Component({
  ...
  <div class="p-4 gap-4">           
       ...
       <br>                   
       <div class=" p-  text-gray-900  block hover:underline">{{option.An}}</div>  
</div>
<br>
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() =>  N1WarehouseComponent),
      multi: true,
    },
  ],
  imports: [FormsModule, CommonModule,  ]
})
export class N1WarehouseComponent {
  @Input() label: string = ' ';
  @Input() value: string = '';

  @Input() option:   management = {
    img: '',
    name : '',
    An : '',
    Learn  : '',
